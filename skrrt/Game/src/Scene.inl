...
void Scene::init(void){
    ...
    geometry["start_menu"]->init("models/Plane.obj", "textures/start_menu.png", "textures/no_emission.png", "textures/no_emission.png", 8);

    // Large background to cover up what the start menu doesn't cover up
    geometry["start_menu_background"] = new Obj;
    geometry["start_menu_background"]->init("models/Plane.obj", "textures/white.png", "textures/no_emission.png", "textures/no_emission.png", 9);

    geometry["end_menu"] = new Obj;
    geometry["end_menu"]->init("models/Plane.obj", "textures/game_over.png", "textures/no_emission.png", "textures/no_emission.png", 10);

    geometry["end_menu_background"] = new Obj;
    geometry["end_menu_background"]->init("models/Plane.obj", "textures/white.png", "textures/no_emission.png", "textures/no_emission.png", 11);
