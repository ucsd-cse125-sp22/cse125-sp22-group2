...
BoundingBox bounding::matchTerrain(BoundingBox object, BoundingBox floor, float maxOffset)
{
	...
	//vertices.push_back(object.corner);
	//vertices.push_back(object.corner + object.aVec);
	//vertices.push_back(object.corner + object.cVec);
	//vertices.push_back(object.corner + object.aVec + object.cVec);
